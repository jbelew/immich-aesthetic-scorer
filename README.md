...
- **Two-Stage Scoring Pipeline**:
  ...
  - **Stage 2 (Aesthetics Evaluation)**: Filters the top percentage of candidates from Stage 1. It invokes commercial multimodal APIs (Gemini/OpenAI) as an expert "photography judge" to perform deep-dive aesthetics, expression, and composition verification.
