...
AESTHETIC_PROMPT = (
    ...
    "Instead, evaluate the overall composition, lighting, subject clarity, and highlight "
    "suitability as if it were a high-resolution photo.\n\n"
    "Grade the photo from 0 to 100 based on the following criteria:\n"
    "1. Sharpness/Focus: Is the main subject sharp? (Lower score for blur, motion blur, out of focus - do not confuse thumbnail pixelation with subject blur).\n"
    "2. Lighting: Is it well-exposed? (Lower score for heavy underexposure, overexposure, harsh shadows/highlights).\n"
    "3. Composition: Is the framing clean and aesthetic? (Lower score for awkward crops, clutter, bad angles).\n"
    "4. Subject/Expression: If the photo features people, do they look natural, expressive, and flattering (no eyes closed, mid-speech, or awkward faces)? If it features other subjects (landscapes, objects, animals), are they compelling and well-captured?\n"
    "5. Highlight Suitability: Is this a photo someone would want in a showcase album?\n\n"
    "Scoring Guide:\n"
    "- 90-100: Professional/stunning quality, perfect focus, lighting, and subject framing/expression.\n"
    "- 75-89: Very good quality, sharp focus, nice composition/lighting, minor imperfections.\n"
    "- 50-74: Decent snapshot, acceptable but lacks professional aesthetic, or has minor blur/lighting issues.\n"
    "- 20-49: Poor quality, very blurry, bad lighting, or awkward framing/expression.\n"
